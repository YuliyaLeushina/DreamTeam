(() => {
      ...
      if (
        ...
        if (0 === t) a[e ? "scrollLeft" : "scrollTop"] = -d;
          ...
          if (!l.support.smoothScroll)
            return (
              $({ swiper: l, targetPosition: -d, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e, t, s, i, n) {
      ...
      if (a.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!l.support.smoothScroll)
            return (
              $({ swiper: l, targetPosition: s, side: e ? "left" : "top" }), !0
            );
    ...
    s({
      ...
      i("click", (e, s) => {
        const { $nextEl: i, $prevEl: l } = t.navigation,
          r = s.target;
        if (t.params.navigation.hideOnClick && !T(r).is(l) && !T(r).is(i)) {
          if (
            t.pagination &&
            t.params.pagination &&
  ...
  window.addEventListener("load", function (e) {
    document.querySelector(".slider__slider") &&
      ...
      document.querySelector(".others__slider") &&
        new oe(".others__slider", {
          modules: [ce],
          observer: !0,
          observeParents: !0,
          slidesPerView: 3,
          ...
          speed: 800,
          navigation: {
            nextEl: ".others-button-next",
            prevEl: ".others-button-prev",
          },
          breakpoints: {
            320: { slidesPerView: 1 },
            606: { slidesPerView: 2 },
  ...
  new pe("max").init(),
    document.querySelectorAll(".card__like").forEach((e) => {
      e.addEventListener("click", () => {
        e.classList.toggle("my-favorite"),
          e.classList.toggle("show-like"),
          e.classList.contains("my-favorite")
            ? (e.style.background = "url('./img/heart-fill.png') no-repeat")
            : ((e.style.background = "url('./img/heart.png') no-repeat"),
              (e.style.backgroundPosition = "center"));
      }),
        e.addEventListener("mouseover", () => {
          e.style.background = "url('./img/heart-red.png') no-repeat";
        }),
